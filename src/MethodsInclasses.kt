...
open class ClassA {
    ...
    fun cantOverride(){ println("ClassA -> cantOverride()") }

    // to allow override of method in subClass need to declare it as open
    open fun canOverride(){ println("ClassA -> canOverride()") }
...
open class ClassC : ClassB() {
    ...
    //any class extending ClassC can't override this method anymore
    final override fun canOverride() {
       println("ClassC -> canOverride()")
    }
