...
//extension functions ... a nice way to basics.add features on a type without having to subtype or extend it
/*fun String.basics.isEmpty() : Boolean {
...
fun main(args: Array<String>) {
    ...
    println("2 basics.multiplyBy 4 is $infixFunCallResult")
